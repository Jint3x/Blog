...
function PostPreview(props: PostPreview_I) {
    return (
        <div className={"w-72 ml-auto mr-auto h-80 rounded shadow-lg shadow shadow-md shadow-personal mt-12 mb-12 overflow-hidden"}>
            <div 
            ...
            >
                ...
                {props.tags.map(tag => <RenderTag name={tag} key={tag} />)}
            </div>
        </div>
    )
}
